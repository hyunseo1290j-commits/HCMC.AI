...
server.listen(PORT,process.env.HOST||'127.0.0.1',()=>console.log(`hcmc.ai local server ready at ${ORIGIN}${GOOGLE_CLIENT_ID?' with Google OAuth':' (OAuth not configured)'}`));
